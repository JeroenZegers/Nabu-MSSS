"""@file encoder_lstm_decoder.py
contains de EncoderLSTMDecoder class"""
...
class EncoderLSTMDecoder(model.Model):
	"""A CNN classifier with encoder-decoder shape where middle layers consist of lstm layers
	(https://pdfs.semanticscholar.org/0c28/12a15657a21de57ff83f7d1bf8b46d41dc63.pdf)
	"""
