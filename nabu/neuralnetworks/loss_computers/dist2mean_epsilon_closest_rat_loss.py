...
class Dist2MeanEpsilonClosestRatLoss(loss_computer.LossComputer):
	...
	loss, norm = ops.dist2mean_epsilon_closest_rat_loss(binary_target, logits, usedbins, 
					seq_length,self.batch_size,epsilon=0.2)
