...
class DeepclusteringnoiseLoss(loss_computer.LossComputer):
    ...
    def __call__(self, targets, logits, seq_length):
        ...
        nrS = tf.shape(binary_target)[2]/tf.shape(energybins)[2]  # Number of speakers in mixture
        ...
        loss, norm = ops.deepclustering_noise_loss(
            binary_target, noise_target, ideal_ratio, emb_vec, alpha, energybins, seq_length, self.batch_size)
