...
class Dist2MeanRatSquaredLoss(loss_computer.LossComputer):
	...
	loss, norm = ops.intravar2centervar_rat_loss(binary_target, logits, usedbins, 
					seq_length,self.batch_size,rat_power=2)
