'''@file crossentropy_multi_loss_reshapelogits_avtime.py
contains the CrossEntropyMultiLossReshapeLogitsAvTime'''
...
class CrossEntropyMultiLossReshapeLogitsAvTime(loss_computer.LossComputer):
