'''@file scorelabelperfeatureinmixture_processor.py
contains the ScorelabelperfeatureinmixtureProcessor class'''
...
class ScorelabelperfeatureinmixtureProcessor(processor.Processor):
    ...
    def __init__(self, conf, segment_lengths):
        '''ScorelabelperfeatureinmixtureProcessor constructor

        Args:
            conf: ScorelabelperfeatureinmixtureProcessor configuration as a dict of strings
        ...
        super(ScorelabelperfeatureinmixtureProcessor, self).__init__(conf)
    ...
    def __call__(self, dataline):
        ...
        tmp=dataline.split('_')[-1]
	fromsample = int(tmp.split('.')[0])
	utt[0:fromsample]=0.0
