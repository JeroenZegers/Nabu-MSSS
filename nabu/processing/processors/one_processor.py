"""@file one_processor.py
contains the OneProcessor class"""
...
class OneProcessor(processor.Processor):
    """a processor for audio files, this will return mask with all elements 1"""
