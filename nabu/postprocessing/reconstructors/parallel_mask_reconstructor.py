'''@file parallel_mask_reconstructor.py
contains the reconstructor class with use of a mask'''

import parallel_reconstructor
from nabu.postprocessing import data_reader
from nabu.processing.feature_computers import base
from abc import ABCMeta, abstractmethod

class ParallelMaskReconstructor(parallel_reconstructor.ParallelReconstructor):
    ...
    def reconstruct_signals(self, ind, output):
